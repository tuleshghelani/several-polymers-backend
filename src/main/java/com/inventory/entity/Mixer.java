...
@Table(name = "mixer", indexes = {
        @Index(name = "idx_mixer_batch_id", columnList = "batch_id"),
...
public class Mixer {
    ...
    @JoinColumn(name = "batch_id", referencedColumnName = "id", foreignKey = @ForeignKey(name = "fk_mixer_batch_id_batch_id"))
    private Batch batch;
